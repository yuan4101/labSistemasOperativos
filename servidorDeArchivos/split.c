 ...
 * Facilita la división de una cadena de caracteres en "palabras"
...
/** Retorna un apuntador a la posición de la cadena en la cual se encuentra 
 * el primer caracter que no es delimitador
 */
char * skip_delimiters(char * str, const char * delim);

/**
 * Retorna un apuntador a la posición de la cadena en la cual se encuentra un 
